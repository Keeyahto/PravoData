...
class StartLinkCreator:
    ...
    def get_start_link(self):
        base_params = {'bpas': '', 'v3': '', 'v3type': '1', 'v3value': '', 'a6': '', 'a6type': '1', 'a6value': '',
                       ...
                       'a8': '', 'a8type': '1', 'a1': '', 'a0': '', 'a16': '', 'a16type': '1', 'a16value': '',
                       'a17': '',
                       'a17type': '1', 'a17value': '', 'a4': '', 'a4type': '1', 'a4value': '', 'a23': '',
                       'a23type': '1',
        ...
        user_params = {'a7type': '4',
                       'bpas': '/'.join(self.region_code).encode('cp1251'),
                       "a6": ';'.join(self.org_code).encode('cp1251') or '',
                       'a6value': ';'.join(self.org_code).encode('cp1251'),
